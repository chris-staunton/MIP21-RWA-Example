...
library DssExecLib {
    ...
    /*** Constants ***/
    /*****************/
    address constant public LOG = 0x7368c1a7E459ab0b53A54867B289F45ceE519550;
...
contract DssExec {
    ...
    Changelog      constant public log   = Changelog(0x7368c1a7E459ab0b53A54867B289F45ceE519550);
    uint256                 public eta;
    bytes                   public sig;
    bool                    public done;
...
contract DssSpellAction is DssAction {
    ...
    string public constant override description =
        "2021-07-26 Testing | Hash: Testing";
    ...
    // Maker changelog
    address public constant MAKER_CHANGELOG = 0x7368c1a7E459ab0b53A54867B289F45ceE519550;

    function actions() public override {
        

        CentrifugeCollateralValues memory RWA999 = CentrifugeCollateralValues({
            MCD_JOIN: 0x6605Bf7168223574A5F9AbcaaBf718cF6c674705,
            GEM: 0xCf6d93E8Da96654771f76f90165B39Ae6647611A,
            OPERATOR: 0x8519cd7e0CF6E757a1Df45c906d640DcEfb2869e,
            INPUT_CONDUIT: 0x917D49182D46D88f6EC39D2d542d491629A32c5E,
            OUTPUT_CONDUIT: 0xe024543da5D4876C234fc70eC4fc6Bc936C43831,
            URN:  0xc9f6b85b362a338BE0De500AD262f0203942e7eE,
            gemID: "RWA999",
            joinID: "MCD_JOIN_RWA999_A",
            urnID: "RWA999_A_URN",
            inputConduitID: "RWA999_A_INPUT_CONDUIT",
            outputConduitID: "RWA999_A_OUTPUT_CONDUIT",
            pipID: "PIP_RWA999",
            ilk: "RWA999-A",
        ...
        integrateCentrifugeCollateral(RWA999);
    ...
    function integrateCentrifugeCollateral(CentrifugeCollateralValues memory collateral) internal {
        address MIP21_LIQUIDATION_ORACLE = 0x107De6aC75955fF63059268e97E34D8f9C951ED8;

        address vat = 0x89821e814fF3a48a5F1424F834f1B3f6018f3DA5;
        // bytes32 tmp = "RWA999-A";
